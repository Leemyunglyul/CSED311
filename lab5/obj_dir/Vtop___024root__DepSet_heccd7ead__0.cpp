...
extern const VlWide<16>/*511:0*/ Vtop__ConstPool__CONST_h8a5cd5b9_0;
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    CData/*3:0*/ __VdlyDim0__top__DOT__cpu__DOT__cache__DOT__valid_bank__v16;
    ...
    CData/*3:0*/ __VdlyDim0__top__DOT__cpu__DOT__cache__DOT__dirty_bank__v16;
    ...
    if (VL_UNLIKELY((vlSelfRef.reset))) {
        ...
        VL_READMEM_N(true, 32, 16384, 0, VL_CVT_PACK_STR_NW(16, Vtop__ConstPool__CONST_h8a5cd5b9_0)
    ...
    if (__VdlySet__top__DOT__cpu__DOT__cache__DOT__dirty_bank__v0) {
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[0U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[1U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[2U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[3U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[4U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[5U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[6U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[7U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[8U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[9U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[0xaU] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[0xbU] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[0xcU] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[0xdU] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[0xeU] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[0xfU] = 0U;
    }
    if (__VdlySet__top__DOT__cpu__DOT__cache__DOT__dirty_bank__v16) {
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__dirty_bank[__VdlyDim0__top__DOT__cpu__DOT__cache__DOT__dirty_bank__v16] 
            = __VdlyVal__top__DOT__cpu__DOT__cache__DOT__dirty_bank__v16;
    }
    if (__VdlySet__top__DOT__cpu__DOT__cache__DOT__valid_bank__v0) {
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[0U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[1U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[2U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[3U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[4U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[5U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[6U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[7U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[8U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[9U] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[0xaU] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[0xbU] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[0xcU] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[0xdU] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[0xeU] = 0U;
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[0xfU] = 0U;
    }
    if (__VdlySet__top__DOT__cpu__DOT__cache__DOT__valid_bank__v16) {
        vlSelfRef.top__DOT__cpu__DOT__cache__DOT__valid_bank[__VdlyDim0__top__DOT__cpu__DOT__cache__DOT__valid_bank__v16] = 1U;
    }
    ...
    vlSelfRef.top__DOT__cpu__DOT__cache__DOT__tag = 
        (vlSelfRef.top__DOT__cpu__DOT__EX_MEM_alu_out 
         >> 8U);
    vlSelfRef.top__DOT__cpu__DOT__cache__DOT__idx = 
        (0xfU & (vlSelfRef.top__DOT__cpu__DOT__EX_MEM_alu_out 
                 >> 4U));
    ...
    vlSelfRef.top__DOT__cpu__DOT__mem_dout = (((0U 
                                              ...
                                              | (vlSelfRef.top__DOT__cpu__DOT__cache__DOT__data_bank
                                                 ...
                                                 (0x1fU 
                                                  & VL_SHIFTL_III(7,7,32, (IData)(vlSelfRef.top__DOT__cpu__DOT__cache__DOT__bo), 5U))));
    vlSelfRef.top__DOT__cpu__DOT__is_hit = ((IData)(vlSelfRef.top__DOT__cpu__DOT__is_input_valid) 
            ...
            if (vlSelfRef.top__DOT__cpu__DOT__is_hit) {
                if ((((IData)(vlSelfRef.top__DOT__cpu__DOT__EX_MEM_mem_write) 
                    ...
                    VL_ASSIGNSEL_WI(128,32,(0x7fU & 
                                            VL_SHIFTL_III(7,32,32, (IData)(vlSelfRef.top__DOT__cpu__DOT__cache__DOT__bo), 5U)), vlSelfRef.top__DOT__cpu__DOT__cache__DOT__cache_in, vlSelfRef.top__DOT__cpu__DOT__EX_MEM_dmem_data);
                }
