...
VL_ATTR_COLD void Vtop___024root___stl_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if (vlSelfRef.top__DOT__cpu__DOT__alu_srcA) {
        ...
        vlSelfRef.top__DOT__cpu__DOT__alu_in_1 = vlSelfRef.top__DOT__cpu__DOT__reg_file__DOT__rf
            [vlSelfRef.top__DOT__cpu__DOT__rs1];
    } else {
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__cpu__DOT__change_pc = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__cpu__DOT__stateCounter__DOT__clk = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__stateCounter__DOT__reset = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__stateCounter__DOT__opcode = VL_RAND_RESET_I(7);
    vlSelf->top__DOT__cpu__DOT__stateCounter__DOT__state = VL_RAND_RESET_I(4);
    vlSelf->top__DOT__cpu__DOT__changeState__DOT__clk = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__changeState__DOT__reset = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__changeState__DOT__next_state = VL_RAND_RESET_I(4);
    vlSelf->top__DOT__cpu__DOT__changeState__DOT__current_state = VL_RAND_RESET_I(4);
