...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ top__DOT__cpu__DOT__change_pc;
        ...
        CData/*0:0*/ top__DOT__cpu__DOT__alu_srcA;
    ...
    struct {
        ...
        CData/*0:0*/ top__DOT__cpu__DOT__stateCounter__DOT__clk;
        CData/*0:0*/ top__DOT__cpu__DOT__stateCounter__DOT__reset;
        CData/*6:0*/ top__DOT__cpu__DOT__stateCounter__DOT__opcode;
        CData/*3:0*/ top__DOT__cpu__DOT__stateCounter__DOT__state;
        CData/*0:0*/ top__DOT__cpu__DOT__changeState__DOT__clk;
        CData/*0:0*/ top__DOT__cpu__DOT__changeState__DOT__reset;
        CData/*3:0*/ top__DOT__cpu__DOT__changeState__DOT__next_state;
        CData/*3:0*/ top__DOT__cpu__DOT__changeState__DOT__current_state;
